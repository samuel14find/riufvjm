...
<dspace:layout locbar="commLink" title="<%= name %>" feedData="<%= feedData %>">
        ...
        <div class="row">
            <div class="col-md-8">
                <h2><%= name %>
                    ...
                    %>
                    : <strong>[<%= ic.getCount(collection) %>]</strong>
                    <%
                        }
                    %>
                    <br>
    ...
    <%-- Browse retirado pois existe a busca lateral facetada--%>

    <form class="well" method="get" action="">
        <% if (loggedIn && subscribed) { %>
        <small><fmt:message key="jsp.collection-home.subscribed"/> <a
                href="<%= request.getContextPath() %>/subscribe"><fmt:message key="jsp.collection-home.info"/></a>
        </small>
        <input class="btn btn-sm btn-info" type="submit" name="submit_unsubscribe"
...
<%
    ...
    <div class="prev-next-links pull-right">
        <%
            if (bi.hasPrevPage()) {
        %>
