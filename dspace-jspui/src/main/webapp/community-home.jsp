    ...
    <div class="container">
            ...
            <div class="panel panel-warning"><div class="panel-heading">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/tools/edit-communities">
                        ...
                        <input class="btn btn-default col-md-2" type="submit"
                               value="<fmt:message key="jsp.general.edit.button"/>" pull/>
                    </form>
                    <% } %>
                    <% if (add_button) { %>
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/tools/edit-communities">
                        ...
                        <input class="btn btn-default col-md-2" type="submit" name="submit"
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2><%= name %>
                                ...
                                %>
                                <a class="statisticsLink btn btn-primary"
                ...
                <div class="row"></div>
<%-- Ao se colocar a div row, subcomunidade fica embaixo de coleção e não do lado--%>
                <div class="">
                    <%
                        boolean showLogos = ConfigurationManager.getBooleanProperty("jspui.community-home.logos", false);
                    %>
                    <%
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <h4 class="list-group-item-heading"><a
                                                href="<%= request.getContextPath() %>/handle/<%= collections[i].getHandle() %>" style="color: #000000;">
                                            <%= collections[i].getMetadata("name") %>
                                        </a>
                                            <%
                                                if (ConfigurationManager.getBooleanProperty("webui.strengths.show")) {
                                            %>
                                           <strong>[<%= ic.getCount(collections[i]) %>]</strong>
                                            <%
                                                }
                                            %>
                                            <% if (remove_button) { %>
                            ...
                            <div class="list-group-item row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <h4 class="list-group-item-heading"><a
                                                href="<%= request.getContextPath() %>/handle/<%= subcommunities[j].getHandle() %>" style="color: #000000">
                                            <%= subcommunities[j].getMetadata("name") %>
                                        </a>
                                            <%
                                                if (ConfigurationManager.getBooleanProperty("webui.strengths.show")) {
                                            %>
                                            <strong>[<%= ic.getCount(subcommunities[j]) %>]<strong/>
                                            <%
                                                }
                                            %>
                                            <% if (remove_button) { %>
